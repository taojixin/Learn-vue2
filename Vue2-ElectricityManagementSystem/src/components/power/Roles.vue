      ...
      <el-table :data="rolelist" border stripe>
        ...
        <el-table-column type="expand">
          <template slot-scope="scope">
            <el-row
              :class="['bdbottop', i1 === 0 ? 'bdtop' : '', 'vcenter']"
              v-for="(item1, i1) in scope.row.children"
              :key="item1.id"
            >
              <!-- 渲染一级权限 -->
              <el-col :span="5">
                <el-tag closable @close="reoveRightById(scope.row, item1.id)">{{
                  item1.authName
                }}</el-tag>
                ...
                >
                  <el-col :span="6">
                    <el-tag
                      type="success"
                      closable
                      @close="reoveRightById(scope.row, item2.id)"
                  ...
                  <el-col :span="18">
                    <el-tag
                      ...
                      :key="item3.id"
                      closable
                      @close="reoveRightById(scope.row, item3.id)"
